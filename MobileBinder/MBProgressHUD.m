...
static float detailFontSize;


#pragma mark - Class methods

+ (MBProgressHUD *) showHUDAddedTo:(UIView *)view animated:(BOOL)animated fontSize:(float)size detailFontSize: (float) detailSize
{
...
+ (MBProgressHUD *) showHUDAddedTo:(UIView *)view animated:(BOOL)animated fontSize: (float) size
{
    return [MBProgressHUD showHUDAddedTo:view animated:animated fontSize:size detailFontSize:kDetailsLabelFontSize];
}
...
- (id)initWithFrame:(CGRect)frame
{
	...
	if (self) {
		...
		self.opacity = 0.8f;
		self.labelFont = [UIFont fontWithName:PROGRESS_INDICATOR_FONT size: fontSize];
		self.detailsLabelFont = [UIFont fontWithName:PROGRESS_INDICATOR_FONT size:detailFontSize];
		self.xOffset = 0.0f;
		self.yOffset = 0.0f;
...
- (void)drawRect:(CGRect)rect {
    ...
    //0.0
	CGContextSetGrayFillColor(context, PROGRESS_INDICATOR_GREY_COLOR, PROGRESS_INDICATOR_OPACITY);
